...
%	META IMAGE
%----------------------------------------------------------------------------------------
\includegraphics[width=\linewidth]{gambar1.jpg}	%trimming relative to image size
...
\icontext{MapMarker}{12}{Lot 3148, Jln Limbong, Kg Telaga Mas\\23100 Paka, Terengganu}{black}\\[6pt]
\icontext{MobilePhone}{12}{+60137737567}{black}\\[6pt]
\iconemail{Envelope}{12}{muim$\_$halim@yahoo.com}{muim_halim@yahoo.com}{black}\\[6pt]
...
\fcolorbox{white}{darkcol}{\begin{minipage}[c][3.5cm][c]{1\mpwidth}
	\begin {center}
		\HUGE{ \textbf{ \textcolor{white}{ \uppercase{ Abd Munim bin Abd Halim } } } } \\[-24pt]
		\textcolor{white}{ \rule{0.1\textwidth}{1.25pt} } \\[4pt]
		\large{ \textcolor{white} {Freelance Website Developer} }
	\end {center}
\end{minipage}} \\[14pt]
\vspace{-12pt}
